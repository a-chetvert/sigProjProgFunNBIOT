...
#define RC_PWR_Pin GPIO_PIN_13
#define RC_PWR_GPIO_Port GPIOB
#define RC_CAP_Pin GPIO_PIN_14
...
#define APDS_SHDN_Pin GPIO_PIN_9
#define APDS_SHDN_GPIO_Port GPIOA
#define RC_RESET_Pin GPIO_PIN_3
#define RC_RESET_GPIO_Port GPIOB
